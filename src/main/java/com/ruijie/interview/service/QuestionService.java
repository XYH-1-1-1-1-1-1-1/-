...
public class QuestionService {
    ...
    private void initBackendQuestions() {
        List<Question> questions = List.of(
            ...
            createQuestion("backend", "数据库",
                ...
                "MVCC、ReadView、Undo Log、Next-Key Lock", 3),
            createQuestion("backend", "数据库",
                "SQL 优化有哪些常见手段？",
            ...
            // 系统设计
            createQuestion("backend", "系统设计",
                "如何设计一个分布式锁？需要考虑哪些问题？",
                "可用 Redis SETNX、ZooKeeper 临时顺序节点实现。需考虑：锁超时、锁续期、可重入、主从切换问题。",
                "Redis 分布式锁、Redlock、WatchDog", 3),
            createQuestion("backend", "系统设计",
     ...
     * 初始化前端开发题库
     */
    private void initFrontendQuestions() {
        List<Question> questions = List.of(
            // JavaScript
            createQuestion("frontend", "JavaScript",
            ...
            // 项目经验
            createQuestion("frontend", "项目经验",
                "请介绍一个你做过的最有挑战性的前端项目，遇到了什么技术难点？",
                "考察项目理解、技术深度、问题解决能力。",
                "项目经历、技术深度", 1),
            
            // 行为题
            createQuestion("frontend", "行为题",
                "你如何保证前端代码的质量？",
     ...
     * 初始化测试工程师题库
     */
    private void initQaQuestions() {
        List<Question> questions = List.of(
            // 测试基础
            createQuestion("qa", "测试基础",
                "测试用例设计有哪些常用方法？",
            ...
            // 项目经验
            createQuestion("qa", "项目经验",
                "请介绍一个你参与的测试项目，你是如何保证测试覆盖率的？",
                "考察测试思维、用例设计能力、质量保障意识。",
                "项目经历、测试覆盖率", 1),
            
            // 行为题
            createQuestion("qa", "行为题",
    ...
    private void initAlgorithmQuestions() {
        List<Question> questions = List.of(
            ...
            createQuestion("algorithm", "深度学习",
                ...
                "Transformer、Attention", 3),
            
            // 编程题
            createQuestion("algorithm", "编程题",
                "手写一个快速排序算法。",
                "考察编码能力、算法理解。",
                "排序、编码能力", 2),
            
            // 项目经验
            createQuestion("algorithm", "项目经验",
     ...
     * 创建问题辅助方法
     */
    private Question createQuestion(String positionId, String category, String content,
                                    String referenceAnswer, String answerPoints, int orderNum) {
        Question q = new Question();
        q.setPositionId(positionId);
        q.setCategory(category);
        q.setContent(content);
        q.setReferenceAnswer(referenceAnswer);
        q.setAnswerPoints(answerPoints);
        q.setDifficultyLevel(3);
        q.setScoreWeight(10);
